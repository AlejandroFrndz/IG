...
Skybox::Skybox(float lado)
{
   ...
   //Cara Frontal
   Tupla3i f1(1,0,3), f2(3,0,2);

   f.push_back(f1);
   f.push_back(f2);

   //Cara Derecha
   Tupla3i f3(11,10,15), f4(15,10,14);

   f.push_back(f3);
   f.push_back(f4);

   //Cara Izquierda
   Tupla3i f5(9,13,8), f6(13,12,8);

   f.push_back(f5);
   f.push_back(f6);

   //Cara Trasera
   Tupla3i f7(5,7,4), f8(7,6,4);

   f.push_back(f7);
   f.push_back(f8);

   //Cara Superior
   Tupla3i f9(16,20,18), f10(18,20,22);

   f.push_back(f9);
   f.push_back(f10);

   //Cara Inferior
   Tupla3i f11(17,19,21), f12(19,23,21);

   f.push_back(f11);
   f.push_back(f12);
}

void Skybox::calcularCoordTex(){
